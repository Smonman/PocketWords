package org.sjk.pocketwords.ebook.parser.exception;

/**
 * Parsing Exception
 *
 * <p>This exception indicates a parsing problem.
 *
...
public class ParsingException extends Exception {
    ...
    /**
     * Constructs an {@code ParsingException} with {@code null} as its error detail message.
     */
    ...
    /**
     * Constructs an {@code ParsingException} with the specified detail message and cause.
     *
    ...
    /**
     * Constructs an {@code ParsingException} with the specified cause and a detail message of
